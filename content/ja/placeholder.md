...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 簡体字中国語の翻訳については、 [<unk> <unk> <unk>](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/placeholder.pdf) をクリックしてください。
{{% /alert %}}
...
{{% image_container width="250" %}}![プレースホルダのプロパティペイン](attachments/layout/placeholder-properties.png)
{{% /image_container %}}
