...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 簡体字中国語の翻訳については、 [<unk> <unk> <unk>](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/entities.pdf) をクリックしてください。
{{% /alert %}}
...
{{% alert type="info" %}}
また、 [Data Hub](data-hub-pane) ペインを使用して、プロジェクト内の他のアプリケーションのデータ ソースを使用することもできます。 これらのデータソースはドメインモデルに *外部エンティティ* として表示され、ドメインモデルでは紫色のエンティティコンテナとして表示されます。 ![仮想エンティティの例](attachments/data-hub-pane/virtual-entity-example.png)
