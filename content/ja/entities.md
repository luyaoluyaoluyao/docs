...
{{% alert type="info" %}}
You can also use data sources from other applications in your project  through the [Data Hub](data-hub-pane) pane. These data sources are represented in the domain model as *external entities* which are displayed as purple entity containers in the domain model: ![Virtual Entity Example](attachments/data-hub-pane/virtual-entity-example.png)
