...
tags:
  ...
  - "マイクロフロー式"
aliases:
  - /ja/refguide/microflow-expressions.html
---
...
名前付きアイテム（例えば、オブジェクト、リスト） または変数)は、アイテムの名前を挿入し、ドル記号を追加することによって式で呼び出すことができます(例えば、  `$customer` は、 `顧客` という名前のオブジェクトを参照することができます。
