...
| ---------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ページを開く     | ページ         | **Page** (Select page) <br />If you want to create a new object and pass it as a context to the selected page, enable **Create Object** (disabled by default) and select an **Entity**. 詳細については、 [イベントセクション](page-editor-widgets-events-section#create-object-option) の *オブジェクトオプション* セクションを参照してください。 <br /> **ページを閉じる** <br />ターゲットページに移動した後に閉じるページ数を制御します。 |
| マイクロフローに発信 | マイクロフロー     | **Microflow** (Select microflow)                                                                                                                                                                                                                                                                                                                                               |
| オブジェクトを作成  | オブジェクトを作成   | **ページ** (ページを選択) と **エンティティ** (図形を選択) <br /> **ページを閉じる** <br />新しいページや編集ページに移動した後に閉じるページ数を制御します。                                                                                                                                                                                                                                                                   |
| 変更を保存      | 変更を保存       | なし                                                                                                                                                                                                                                                                                                                                                                             |
| オブジェクトを削除  | オブジェクトを削除   | なし                                                                                                                                                                                                                                                                                                                                                                             |
| 変更をキャンセル   | 変更をキャンセル    | なし                                                                                                                                                                                                                                                                                                                                                                             |
| ページを閉じる    | ページを閉じる     | **ページを閉じる** 閉じるページ数を制御する。                                                                                                                                                                                                                                                                                                                                                      |
| サインアウト     | サインアウト      | なし                                                                                                                                                                                                                                                                                                                                                                             |
