...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 簡体字中国語の翻訳については、 [<unk> <unk> <unk>](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/import-mappings.pdf) をクリックしてください。
{{% /alert %}}

## 1つの紹介

マッピングをインポートする方法については、 [マッピングドキュメント](mapping-documents) を参照してください。

## 2 マッピングをインポートしてオブジェクトを取得する
