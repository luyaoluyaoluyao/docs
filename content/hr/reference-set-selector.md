...
![](attachments/pages/reference-set-selector.png) In this data view on customer you can select multiple groups using the reference set selector.

![](attachments/pages/reference-set-selector-domain-model.png) In the domain model there is an association of type reference set from customer to group.
