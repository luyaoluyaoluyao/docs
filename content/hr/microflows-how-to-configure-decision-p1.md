...
9. Open the properties for the **Show Page** activity and do the following:
    ...
    2. In the **Select Page** dialog box, click the plus icon in the top right corner, and [create a page](/studio/page-editor) for customer grade **Bronze**. Note that after you create a page, it will be added to the **Select field** automatically.
