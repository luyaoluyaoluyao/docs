...
From the **Errors** pane, you can suppress a warning for a document, a module, or the entire project: ![Suppressing a Warning](attachments/suppression-rules/suppressing-warning.png)
