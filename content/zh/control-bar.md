...
aliases:
  - /refguide8/附加按钮.html
  - /refguide8/deselect-all-按钮.html
  - /refguide8/export-to-csv-buton.html
  - /refguide8/export-excel-buton.html
  - /refguide8/grid-action-buton.html
  - /refguide8/grid-new-buton.html
  - /refguide8/remove-button.html
  - /refguide8/search-button.html
  - /refguide8/select-all-buton.html
  - /refguide8/select-button.html
---

{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 对于简体中文翻译，请点击 [中文为 xix x](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/control-bar.pdf)。
{{% /报警 %}}
