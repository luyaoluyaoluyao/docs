...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 对于简体中文翻译，请点击 [中文为 xix x](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/layout-grid.pdf)。
{{% /报警 %}}
...
如果您的项目有 [Mendix 8版本，下面描述的行和列属性是可用的。 .1](/releasenotes/studio-pro/8.5) 或以上和 [Atlas界面资源](/appstore/modules/atlas-ui-resources) 2.4.0或以上版本。
