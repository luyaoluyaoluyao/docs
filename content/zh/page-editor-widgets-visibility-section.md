...
To see which widgets that have conditional visibility configured, click the eye icon is the **Show** option in the top-left corner of a page: ![Show Option](attachments/page-editor-widgets-visibility-section/highlight-conditional-items.png)
