...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 对于简体中文翻译，请点击 [中文为 xix x](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/data-grid.pdf)。
{{% /报警 %}}
...
以表格式显示对象列表。 例如，数据网格可以显示客户的名称、等级和客户发出的所有订单：
