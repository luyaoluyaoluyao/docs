...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 对于简体中文翻译，请点击 [中文为 xix x](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/template-grid.pdf)。
{{% /报警 %}}
...
#### 3.4.2 显示分页按钮 {#show-paging-buttons}
...
#### 3.4.8 选择前 {#select-first}

此属性表示第一项是否将被初选中。 如果有数据视图监听这个网格，这一点特别有用。

默认： *False*

#### 3.4.9 默认按钮触发 {#default-button-trigger}
