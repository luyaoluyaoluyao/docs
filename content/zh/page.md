...
{{% alert type="info" %}}
<img src="attachments/chinese-translation/china.png" style="display: inline-block; margin: 0" /> 对于简体中文翻译，请点击 [中文为 xix x](https://cdn.mendix.tencent-cloud.com/documentation/refguide8/page.pdf)。
{{% /报警 %}}
...
1. 在 [Project Explorer](project-explorer)中，打开此页面所在的模块。
...
1.  在 [工程资源管理器](project-explorer)， 右键单击模块或您想要创建页面的文件夹，并选择 **添加页面**
...
1. 在 [工程资源管理器](project-explorer)中，选择一个你想要删除的页面并右键单击它。
...
* 小部件显示时不适用于它们的样式。 但你可以看到哪些小部件通过类或样式属性应用了样式，点击 **显示样式** 按钮。
...
例如，上面 [结构模式](#structure-mode)的示例页面将会在 **设计模式** 中显示一个平板电脑：
